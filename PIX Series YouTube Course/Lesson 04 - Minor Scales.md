---
title: Lesson 04 - Minor Scales
course: PIX Series YouTube Course
type: lesson-note
source: https://pixseries.com/lesson-4/
channel: PIX Series
lesson_number: 4
date: 2026-08-19
status: in-progress
...
> [!info] Source
> 📄 Companion PDF: [Minor Scales](https://pixseries.com/wp-content/uploads/2022/03/Lesson-4-Minor-Scales.pdf) via [pixseries.com/lesson-4](https://pixseries.com/lesson-4/)
> ⚠️ Exact YouTube video link not confirmed — couldn't verify it by search (title doesn't follow the "Lesson #N" pattern lessons 1–3 used). Replace with the real link when you have it.

> [!info] At a glance — the [[Minor Scale]] formula
...
- [ ] C, F, A# Minor — ascending + descending, RH only
